...
public class PropertyRegistry {
    ...
    public static final String CONTEXT_ENABLE_SPRING_ANNOTATION = "enableSpringAnnotation"; //$NON-NLS-1$
    ...
    //SqlMapGeneratorConfiguration相关
    public static final String SQL_XML_MAPPER_PREFIX = "xmlMapperPrefix"; //$NON-NLS-1$
    public static final String SQL_XML_MAPPER_SUFFIX = "xmlMapperSuffix"; //$NON-NLS-1$
